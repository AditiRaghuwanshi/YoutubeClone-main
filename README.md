...
## GITHUB REPOSITORY LINK - https://github.com/AditiRaghuwanshi/YoutubeClone-main
...
```text
http://loipconfig /flushdnscalhost:3000
```
...
- `mayank@example.com  / password1234`
- `himeesh@example.com / password1234`
- `samay@example.com / password1234`
